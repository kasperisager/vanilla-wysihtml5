...
!function(t,o){o.Editor=o.Editor||function(o){this.options={textarea:".js-text-box"},o&&t.extend(this.options,o)},Editor.prototype.attachEditor=function(o){var r=t(o),i=t(".js-editor-toolbar",r.closest("form"));if(!r.data("editor")){var e=new wysihtml5.Editor(o,{toolbar:i[0],parserRules:wysihtml5ParserRules,useLineBreaks:!1,stylesheets:gdn.url("/plugins/wysihtml5/design/editor.css")});r.data("editor",e)}},Editor.prototype.attachEditorHandler=function(){var o=this;t(this.options.textarea).each(function(){o.attachEditor(this)})},Editor.prototype.clearEditor=function(o){var r=t(o).data("editor");r.clear()},Editor.prototype.clearEditorHandler=function(o){var r=this;t(this.options.textarea,o.target).each(function(){r.clearEditor(this)})}}(jQuery,window,document);
