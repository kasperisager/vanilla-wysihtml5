...
(function(){!function(t){var i;return i=function(){function i(i){this.$iframe=t(i),this.$body=this.findBody(),this.addBodyStyles(),this.setupEvents(),this.adjustHeight()}return i.prototype.addBodyStyles=function(){return this.$body.css("overflow","hidden"),this.$body.css("min-height",0)},i.prototype.setupEvents=function(){var t=this;return this.$body.on("keyup keydown paste change focus",function(){return t.adjustHeight()})},i.prototype.adjustHeight=function(){return this.$iframe.css("min-height",this.$body.height()+this.extraBottomSpacing())},i.prototype.extraBottomSpacing=function(){return parseInt(this.$body.css("line-height"))||this.estimateLineHeight()},i.prototype.estimateLineHeight=function(){return 1.14*parseInt(this.$body.css("font-size"))},i.prototype.findBody=function(){return this.$iframe.contents().find("body")},i}(),t.fn.wysihtml5_size_matters=function(){return this.each(function(){var e;return e=t.data(this,"wysihtml5_size_matters"),e?void 0:e=t.data(this,"wysihtml5_size_matters",new i(this))})}}($)}).call(this);
!function(t,o){o.Editor=o.Editor||function(o){this.options={textarea:".js-text-box"},o&&t.extend(this.options,o)},Editor.prototype.attachEditor=function(o){var e=t(o),r=t(".js-editor-toolbar",e.closest("form"));if(!e.data("editor")){var i=new wysihtml5.Editor(o,{toolbar:r[0],parserRules:wysihtml5ParserRules,useLineBreaks:!1,stylesheets:t('link[href*="Wysihtml5/design/editor.css"]').attr("href")});e.data("editor",i),e.on("appendHtml",function(t,o){quote=o.replace("\n","<br>"),e.data("editor").composer.commands.exec("insertHTML",'<div class="WrapQuote">'+quote+"</div>")}),i.on("load",function(){var o=t(i.composer.iframe),e=t("body",o.contents());t(o).wysihtml5_size_matters(),gdn.atCompleteInit&&gdn.atCompleteInit(e[0],o[0])}),e.data("editor",i)}},Editor.prototype.attachEditorHandler=function(){var o=this;t(this.options.textarea).each(function(){o.attachEditor(this)})},Editor.prototype.clearEditor=function(o){var e=t(o).data("editor");e.clear()},Editor.prototype.clearEditorHandler=function(o){var e=this;t(this.options.textarea,o.target).each(function(){e.clearEditor(this)})}}(jQuery,window,document);
!function(o,n,d){var r=["ready","EditCommentFormLoaded"],e=["clearCommentForm"],t=new Editor({textarea:".BodyBox"});o(d).on(r.join(" "),t.attachEditorHandler.bind(t)).on(e.join(" "),t.clearEditorHandler.bind(t)),o.fn.autogrow=o.noop}(jQuery,window,document);