...
!function(t,o){o.Editor=o.Editor||function(o){this.options={textarea:".js-text-box"},o&&t.extend(this.options,o)},Editor.prototype.attachEditor=function(o){var i=t(o),r=t(".js-editor-toolbar",i.closest("form"));if(!i.data("editor")){var e=new wysihtml5.Editor(o,{toolbar:r[0],parserRules:wysihtml5ParserRules,useLineBreaks:!1,stylesheets:gdn.url("/plugins/wysihtml5/design/editor.css")});e.on("load",function(){var o=t(e.composer.iframe),i=t("body",o.contents());gdn.atCompleteInit&&gdn.atCompleteInit(i[0],o[0])}),i.data("editor",e)}},Editor.prototype.attachEditorHandler=function(){var o=this;t(this.options.textarea).each(function(){o.attachEditor(this)})},Editor.prototype.clearEditor=function(o){var i=t(o).data("editor");i.clear()},Editor.prototype.clearEditorHandler=function(o){var i=this;t(this.options.textarea,o.target).each(function(){i.clearEditor(this)})}}(jQuery,window,document);
